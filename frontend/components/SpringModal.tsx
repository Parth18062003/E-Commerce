    ...
    >
      ...
      >
        ...
        <div className="relative z-10 text-center md:text-left flex-1">
          <h3 className="text-2xl font-bold mb-2 text-indigo-600">{product.name}</h3>
          <p className="text-lg text-zinc-700 mb-1">{product.brand}</p>
          <p className="text-xl font-semibold mb-4 text-indigo-800">${product.price}</p>
          <div className="flex flex-col gap-2">
            <button
              ...
              className="bg-indigo-600 hover:bg-indigo-700 transition-colors text-zinc-100 font-semibold w-full py-2 rounded"
            >
            ...
            <button
              ...
              className="bg-zinc-600 hover:bg-zinc-700 transition-colors text-zinc-100 font-semibold w-full py-2 rounded"
            >
