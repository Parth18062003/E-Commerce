...
public class RabbitConfig {
    ...
    @Bean
    public Binding inventoryUpdateBinding(Queue inventoryUpdateQueue, FanoutExchange exchange) {
        return BindingBuilder.bind(inventoryUpdateQueue).to(exchange);
    }

    @Bean
    public Binding inventoryCheckBinding(Queue inventoryCheckQueue, FanoutExchange exchange) {
        return BindingBuilder.bind(inventoryCheckQueue).to(exchange);
    }

    @Bean
    public Binding inventoryResponseBinding(Queue inventoryResponseQueue, FanoutExchange exchange) {
        return BindingBuilder.bind(inventoryResponseQueue).to(exchange);
    }
    ...
    public SimpleMessageListenerContainer messageListenerContainer(ConnectionFactory connectionFactory,
        ...
        container.setQueues(inventoryResponseQueue());

        MessageListenerAdapter listenerAdapter = new MessageListenerAdapter(productEventListener, "receiveInventoryResponse");
